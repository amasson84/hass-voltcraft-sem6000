...
def discover(timeout=15, bluetooth_device='hci0'):
    """
    ...
    devices = copy.deepcopy(bluetooth_lowenergy_interface.discover(timeout, service_uuids=[SERVICECLASS_UUID]))
    bluetooth_lowenergy_interface.disconnect()
    return devices
...
class SEM6000():
    ...
    def __init__(self, deviceAddr=None, pin=None, bluetooth_device='hci0', timeout=15, debug=False):
    ...
    def _send_command(self, command):
        ...
        self._bluetooth_lowenergy_interface.write_to_characteristic(SEM6000.CHARACTERISTIC_UUID_CONTROL,
                                                                    encoded_command)
    ...
    def change_prices(self, normal_price_in_cent, reduced_period_price_in_cent):
        ...
        """
        command = ChangePricesCommand(normal_price_in_cent=int(normal_price_in_cent),
                                      reduced_period_price_in_cent=int(reduced_period_price_in_cent))
        self._send_command(command)
        notification = self._consume_notification()
