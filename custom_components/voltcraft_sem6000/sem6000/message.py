...
class ChangePricesCommand():
    ...
    def __str__(self):
        name = self.__class__.__name__
        return name + "(normal_price_in_cent=" + str(
            self.normal_price_in_cent) + ", reduced_period_price_in_cent=" + str(
            self.reduced_period_price_in_cent) + ")"
...
class ChangeReducedPeriodCommand():
    ...
    def __str__(self):
        name = self.__class__.__name__
        return name + "(is_active=" + str(self.is_active) + ", start_isotime=" + str(
            self.start_isotime) + ", end_isotime=" + str(self.end_isotime) + ")"
...
class SetTimerCommand:
    ...
    def __str__(self):
        name = self.__class__.__name__
        return name + "(is_reset_timer=" + str(self.is_reset_timer) + ", is_action_turn_on=" + str(
            self.is_action_turn_on) + ", target_isodatetime=" + str(self.target_isodatetime) + ")"
...
class ChangeRandomModeCommand:
    ...
    def __str__(self):
        ...
        name = self.__class__.__name__
        return name + "(is_active=" + str(
            self.is_active) + ", active_on_weekdays=" + active_on_weekdays + ", start_isotime=" + str(
            self.start_isotime) + ", end_isotime=" + str(self.end_isotime) + ")"
...
class SettingsRequestedNotification:
    def __init__(self, is_reduced_period, normal_price_in_cent, reduced_period_price_in_cent,
                 reduced_period_start_isotime, reduced_period_end_isotime, is_nightmode_active, power_limit_in_watt):
    ...
    def __str__(self):
        name = self.__class__.__name__
        return name + "(is_reduced_period=" + str(self.is_reduced_period) + ", normal_price_in_cent=" + str(
            self.normal_price_in_cent) + ", reduced_periiod_price_in_cent=" + str(
            self.reduced_period_price_in_cent) + ", reduced_period_start_isotime=" + str(
            self.reduced_period_start_isotime) + ", reduced_period_end_isotime=" + str(
            self.reduced_period_end_isotime) + ", is_nightmode_active=" + str(
            self.is_nightmode_active) + ", power_limit_in_watt=" + str(self.power_limit_in_watt) + ")"
...
class TimerStatusRequestedNotification:
    ...
    def __str__(self):
        name = self.__class__.__name__
        return name + "(is_active=" + str(self.is_active) + ", is_action_turn_on=" + str(
            self.is_action_turn_on) + ", target_isodatetime=" + str(
            self.target_isodatetime) + ", original_timer_length_in_seconds=" + str(
            self.original_timer_length_in_seconds) + ")"
...
class OneTimeScheduler(Scheduler):
    ...
    def __str__(self):
        ...
        return name + "(is_active=" + str(self.is_active) + ", is_action_turn_on=" + str(
            self.is_action_turn_on) + ", isodatetime=" + str(self.isodatetime) + ")"
...
class RepeatedScheduler(Scheduler):
    ...
    def __str__(self):
        ...
        return name + "(is_active=" + str(self.is_active) + ", is_action_turn_on=" + str(
            self.is_action_turn_on) + ", repeat_on_weekdays=" + repeat_on_weekdays + ", isotime=" + isotime + ")"
...
class SchedulerRequestedNotification:
    ...
    def __str__(self):
        ...
        return name + "(number_of_schedulers=" + str(
            self.number_of_schedulers) + ", scheduler_entries=" + scheduler_entries + ")"
...
class MeasurementRequestedNotification:
    def __init__(self, is_power_active, power_in_milliwatt, voltage_in_volt, current_in_milliampere, frequency_in_hertz,
                 total_consumption_in_kilowatt_hour):
    ...
    def __str__(self):
        name = self.__class__.__name__
        return name + "(is_power_active=" + str(self.is_power_active) + ", power_in_milliwatt=" + str(
            self.power_in_milliwatt) + ", voltage_in_volt=" + str(
            self.voltage_in_volt) + ", current_in_milliampere=" + str(
            self.current_in_milliampere) + ", frequency_in_hertz=" + str(
            self.frequency_in_hertz) + ", total_consumption_in_kilowatt_hour=" + str(
...
class ConsumptionOfLast12MonthsRequestedNotification:
    ...
    def __str__(self):
        name = self.__class__.__name__
        return name + "(consumption_n_months_ago_in_watt_hour=" + util._format_list_of_objects(str,
                                                                                               self.consumption_n_months_ago_in_watt_hour) + ")"
...
class ConsumptionOfLast30DaysRequestedNotification:
    ...
    def __str__(self):
        name = self.__class__.__name__
        return name + "(consumption_n_days_ago_in_watt_hour=" + util._format_list_of_objects(str,
                                                                                             self.consumption_n_days_ago_in_watt_hour) + ")"
...
class ConsumptionOfLast23HoursRequestedNotification:
    ...
    def __str__(self):
        name = self.__class__.__name__
        return name + "(consumption_n_hours_ago_in_watt_hour=" + util._format_list_of_objects(str,
                                                                                              self.consumption_n_hours_ago_in_watt_hour) + ")"
